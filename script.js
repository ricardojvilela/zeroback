...
const translatedAddons = {
  pt: {
    ...
    batchLimitNote: "{limit} imagens grátis",
...
const proTranslations = {
  pt: {
    ...
    inlineProCta: "Mais de {limit} imagens? Receba Pro Trial",
    proInlineKicker: "Pro Trial gratuito",
    proInlineTitle: "Receba o link para processar até 100 imagens por lote",
    proInlineLead: "O Pro Trial foi criado para lojas e equipas que têm muitas fotos para preparar. Deixe o email e receba acesso manual durante 15 dias.",
    proInlineBenefits: "15 dias grátis. Até 100 imagens por lote. PNG individual e ZIP completo.",
  ...
  en: {
    ...
    inlineProCta: "More than {limit} images? Get Pro Trial",
    proInlineKicker: "Free Pro Trial",
    proInlineTitle: "Get the link to process up to 100 images per batch",
    proInlineLead: "Pro Trial is built for stores and teams with many product photos to prepare. Leave your email and receive manual access for 15 days.",
    proInlineBenefits: "15 days free. Up to 100 images per batch. Individual PNGs and full ZIP export.",
    proEmailPlaceholder: "Your email",
    proInlineButton: "Get Pro Trial link",
    proInlineNote: "No payment. Use real product photos and tell us whether this workflow would be worth paying for.",
    proInlineSuccess: "Request received. We will send the Pro Trial link by email.",
    proInlineError: "We could not submit automatically. Opening an email draft instead.",
    downloadReadyHint: "Result ready. Download PNG or ZIP to use in your stores and catalogues.",
    zipProCta: "Want up to 100 images per batch? Get Pro Trial",
