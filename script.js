...
const translations = {
  pt: {
    ...baseTranslation,
    pageTitle: "Remover Fundo em Lote",
    languageLabel: "Idioma",
    eyebrow: "Remoção de fundo em massa",
    title: "Remover Fundo em Lote",
    lead: "Remova o fundo de várias fotos ao mesmo tempo e exporte imagens prontas para lojas online, catálogos e redes sociais.",
  ...
  en: {
    ...baseTranslation,
    pageTitle: "Bulk Background Remover",
    languageLabel: "Language",
    eyebrow: "Bulk background removal",
    title: "Bulk Background Remover",
    lead: "Remove backgrounds from many photos at once and export images ready for online stores, catalogues, and social media.",
  ...
  es: {
    ...baseTranslation,
    pageTitle: "Quitar Fondo por Lotes",
    languageLabel: "Idioma",
    eyebrow: "Eliminación de fondo en masa",
    title: "Quitar Fondo por Lotes",
  ...
  fr: {
    ...baseTranslation,
    pageTitle: "Suppression d'arrière-plan par lots",
    languageLabel: "Langue",
    eyebrow: "Suppression d'arrière-plan en masse",
    title: "Suppression d'arrière-plan par lots",
  ...
  de: {
    ...baseTranslation,
    pageTitle: "Hintergründe im Stapel entfernen",
    languageLabel: "Sprache",
    eyebrow: "Hintergrundentfernung in großen Mengen",
    title: "Hintergründe im Stapel entfernen",
  ...
  it: {
    ...baseTranslation,
    pageTitle: "Rimuovi sfondo in blocco",
    languageLabel: "Lingua",
    eyebrow: "Rimozione sfondo di massa",
    title: "Rimuovi sfondo in blocco",
  ...
  nl: {
    ...baseTranslation,
    pageTitle: "Achtergrond in bulk verwijderen",
    languageLabel: "Taal",
    eyebrow: "Achtergrond verwijderen in bulk",
    title: "Achtergrond in bulk verwijderen",
  ...
  pl: {
    ...baseTranslation,
    pageTitle: "Usuwanie tła hurtowo",
    languageLabel: "Język",
    eyebrow: "Masowe usuwanie tła",
    title: "Usuwanie tła hurtowo",
  ...
  sv: {
    ...baseTranslation,
    pageTitle: "Ta bort bakgrund i bulk",
    languageLabel: "Språk",
    eyebrow: "Bakgrundsborttagning i bulk",
    title: "Ta bort bakgrund i bulk",
  ...
  da: {
    ...baseTranslation,
    pageTitle: "Fjern baggrund i bulk",
    languageLabel: "Sprog",
    eyebrow: "Baggrundsfjernelse i bulk",
    title: "Fjern baggrund i bulk",
  ...
  no: {
    ...baseTranslation,
    pageTitle: "Fjern bakgrunn i bulk",
    languageLabel: "Språk",
    eyebrow: "Bakgrunnsfjerning i bulk",
    title: "Fjern bakgrunn i bulk",
    ...
    ...baseTranslation,
    pageTitle: "Poista tausta eränä",
    languageLabel: "Kieli",
    eyebrow: "Taustan poisto eränä",
    title: "Poista tausta eränä",
