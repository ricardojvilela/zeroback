...
const baseTranslation = {
  ...
  postDownloadNextText: "Se o resultado ficou bom, compre o Pack 100 por 5 EUR para tratar um lote real sem subscrição. Se isto passar a ser mensal, escolha Pro recorrente.",
...
const translations = {
  ...
  en: {
    ...
    postDownloadNextText: "If the result looks good, buy the 100 image pack for EUR 5 to process a real batch without a subscription. If this becomes monthly work, choose recurring Pro.",
...
const translatedAddons = {
  ...
  es: {
    ...
    postDownloadNextText: "Si el resultado quedó bien, compra el Pack 100 por 5 EUR para procesar un lote real sin suscripción. Si pasa a ser trabajo mensual, elige Pro recurrente.",
