...
const baseTranslation = {
  ...
  postDownloadNextText: "Se o resultado ficou bom, transforme este teste em produção: plano fundador por 15 EUR/mês, lotes até 100 imagens e 2.000 imagens por mês. Se ainda está a avaliar, guarde o link por email.",
...
const translations = {
  ...
  en: {
    ...
    postDownloadNextText: "If the result looks good, turn this test into production: founder plan at EUR 15/month, batches up to 100 images, and 2,000 images per month. If you are still evaluating, save the link by email.",
