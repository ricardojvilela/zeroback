...
const translations = {
  pt: {
    ...
    title: "BatchCutout",
    lead: "Remova fundos de vÃ¡rias fotos ao mesmo tempo e exporte PNGs transparentes prontos para lojas online, catÃ¡logos e redes sociais.",
    benefitBatch: "Feito para muitas fotos",
    uploadLabel: "Carregar fotos",
    startNow: "ComeÃ§ar agora",
    uploadTitle: "Carregue as suas fotos",
    clear: "Limpar",
    selectPhotos: "Arraste atÃ© {limit} imagens grÃ¡tis",
    fileTypes: "PNG transparente ou ZIP organizado em poucos cliques",
  ...
  en: {
    ...
    clear: "Clear",
    selectPhotos: "Drag up to {limit} images free",
    fileTypes: "Transparent PNG or organised ZIP in a few clicks",
