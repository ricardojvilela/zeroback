...
## Pack funnel reporting scope - 2026-07-30

The authenticated dashboard showed zero people clicking Pack after a completed free test while its Google Ads source row showed one Pack click event. These figures measure different scopes: the headline cohort counts unique people only when their Pack click follows a completed `free_total_2` test, while the source table counts operational click events in the reporting window and can include clicks before completion or repeated clicks.

The dashboard now states both scopes explicitly in the validation cards, funnel cards, conversion label and source-table header. Automated coverage prevents those labels from reverting to an ambiguous shared name. The underlying events and cohort rules were left unchanged. At this checkpoint the 14-day panel had 103 unique visitors, 17 uploads, five completed free tests, no post-test Pack click in the cohort and no unresolved message at `support@batchcutout.com`. No price, offer, campaign, budget or email action changed.

## Daily paid-entry activation comparison - 2026-07-30

The authenticated Google Ads account reported two clicks, nine impressions and 4.74 EUR cost on the incomplete 2026-07-30 day, all from `Search - BatchCutout - Pro Launch`. The active ad points to the English bulk landing with `utm_source=google_ads`, `utm_medium=cpc`, `utm_campaign=bulk_background_remover` and `utm_content=search`. The application dashboard reported six visitors and no upload today, but its daily brief did not expose paid direct entries, tool views or file-picker opens, so the two Ads clicks could not be compared with the repaired handoff without relying on uncertain click timing.

The daily brief now displays `Entrada paga direta`, `Ferramenta aberta` and `Seletor de ficheiros`, each with comparison against yesterday. Its automatic diagnosis identifies paid-entry or general tool-view cohorts that fail to open the selector before recommending any budget increase, price change or checkout work. Existing event rows already contained these fields, so no tracking contract or historical data was changed. Automated coverage protects the three daily stages and their decision gates. No ad, budget, price, offer or email action changed.

## Paid redirect delivery verification - 2026-07-30

An isolated production visit used the live English Google Ads route with a click identifier and `utm_source=codex_validation`. Chrome reached the expected English upload workspace while preserving the campaign parameters. Supabase then confirmed one `seo_landing_view`, one `paid_landing_tool_redirect` and the following `tool_page_view` under the dedicated `paid_redirect_probe` campaign.

The direct-entry beacon therefore survives the immediate page replacement in the current production implementation. No redirect delay or landing behavior was changed. The same-day gap between two Google Ads clicks and zero commercial direct-entry events cannot be reconstructed because the click times are unavailable, but it is not evidence of a current redirect-delivery defect.

The stats API now reports aggregate internal-validation delivery separately behind the authenticated admin endpoint, and a hidden panel output makes that status available to automated checks. These events remain excluded from every visitor, funnel, campaign, revenue and conversion metric. Automated coverage protects both the separation and the diagnostic summary. No ad, budget, price, offer or email action changed.

## Daily commercial review - 2026-07-31 09:40 Europe/Lisbon

Production returned HTTP 200 for the public site, pricing, admin and authentication configuration routes. The repository was clean at commit `a8e2804` before this review. At 09:40 the current day had no visitor, Google Ads impression, click, upload, download, checkout or revenue, so no same-day conversion conclusion is possible.

The authenticated application panel reported 95 unique visitors, 18 uploads, eight downloads, five completed `free_total_2` tests, one pricing click and no checkout or revenue over 14 days. Over 30 days it reported 221 unique visitors, 47 uploads, 27 downloads, six completed tests, eight pricing clicks, two Pack Stripe sessions, one genuine Pack purchase and 9 EUR revenue. There were no paid subscriptions, renewable MRR, payment failures or paid-credit reservation failures. The offer gate remains blocked at six of 30 completed tests after 19 full days. The genuine Pack customer remains active with all 250 credits unused and has not started a paid batch. `support@batchcutout.com` contained two resolved messages and zero unresolved messages.

Google Ads reported 57 clicks, 502 impressions and 166.56 EUR cost over the 14 complete days from 17 through 30 July, with zero conversions in that window. Pro Launch contributed 38 clicks and 130.24 EUR; Alternatives contributed 19 clicks and 36.32 EUR. Over the 30 complete days from 1 through 30 July, the account reported 126 clicks, 1,128 impressions, 327.23 EUR cost and one 9 EUR conversion. Pro Launch contributed 97 clicks and 266.97 EUR; Alternatives contributed 29 clicks and 60.26 EUR. Pro Launch remains active at 8 EUR/day, Alternatives at 2 EUR/day and Campaign #1 remains paused.

The 250 EUR Google Ads promotion is active and has financed 91.61 EUR, or 36.64% of its value. The separate 400 EUR promotion remains processing after its requirements were met. Google Ads nevertheless shows a current payable balance of 177.01 EUR and the next automatic payment on 1 August. Billing activity shows the 91.61 EUR promotional credit already deducted from a 265.17 EUR running balance, followed by 3.45 EUR estimated UK digital-services tax. No billing or campaign setting was changed.
...
Desktop at 1440 by 900 pixels and mobile at 390 by 844 pixels were checked after the update. The content remained contained and the added grids were balanced at both widths. Production returned the updated title, H1 and FAQ structured data after deployment at commit `52883e0`. Search Console confirmed that the URL is indexed, crawl and indexing are allowed, and the Google-selected canonical matches the declared English URL; it then accepted the updated page into the priority crawl queue. The next measurement gate is at least 14 complete days of post-recrawl query data; compare impressions, average position and clicks for the two product-photo queries before making another change to this page. No price, offer, campaign, budget or email action changed.

## Post-download decision measurement - 2026-08-05

Production, pricing, admin and authentication routes were healthy before this change, and the repository was clean and synchronized at commit `c91f3cb`. At 09:12 the current day had one unique visitor and one tool view, with no upload, download, Stripe session or revenue. Over 14 days the authenticated dashboard reported 70 unique visitors, 10 uploads, seven completed results, six downloads, three completed `free_total_2` tests and no Pack click, checkout or revenue. Over 30 days it reported 196 unique visitors, 43 uploads, 32 completed results, 27 downloads, eight completed tests, two Pack Stripe sessions, one genuine Pack purchase and 9 EUR revenue. There was no paid subscription or real renewable MRR.

The existing post-download offer had been shown to five people over 14 days, alongside six upgrade prompts, but recorded no Pack click, saved-link request or feedback response. The feedback question was technically available after download but visually separated from the post-download decision panel, and its exposure was not measured. This prevented a distinction between a question that users saw and ignored and one they never noticed.

The one-tap question now appears as an unframed final row inside the visible post-download panel, below the Pack action and without changing its four answer choices. A separate `post_download_feedback_shown` event records exposure once per completed download journey. The admin dashboard reports question views, responses and the response-to-view rate, so future reviews can identify whether the constraint is lack of immediate need, output quality, missing final-background workflow or value perception.

An end-to-end local browser run processed two real images, downloaded the ZIP, displayed the integrated question and confirmed the response acknowledgement. The panel was checked at 1440-pixel desktop and 390-pixel mobile widths without overlap or clipped text. All 53 automated tests and the production build passed. The experiment gate remains blocked at eight of 30 completed free tests; its elapsed-time condition is already satisfied. No price, free allowance, offer, checkout path, campaign, budget or email action changed.

Search Console through 2026-08-02 reported two clicks, 164 impressions, 1.2% CTR and average position 56 over 28 days. The updated English product-photo page had 61 impressions and no click, while its 14-day post-recrawl measurement gate remains open. Google Ads showed all three campaigns paused and no impressions, clicks or cost for 1 through 3 August. The support mailbox contained no customer enquiry or buyer reply; its eight unresolved items were newsletters, launch-directory messages or automated status mail and did not justify a commercial response.

## Organic proof and partner distribution - 2026-08-07

The authenticated dashboard reported 70 unique visitors, 10 uploads, seven completed results, six downloads and three completed `free_total_2` tests over 14 days. The offer gate remains blocked at eight of 30 completed tests after the time requirement was met. Today had six visitors and six tool views but no file-picker open, upload, download, checkout or revenue. The support inbox contained 17 messages, of which eight unresolved items were newsletters, directory mail or automated status messages; there was no customer enquiry or buyer reply requiring a response.

The public proof was replaced with an actual production recording from upload through transparent PNG download. The input and exact downloaded output are shown together on Portuguese and English proof pages, with an explicit disclosure that idle periods were removed and waits accelerated 2x. The same real proof now supports the Portuguese and English partner pages. Desktop and 390-pixel mobile checks found no overlap or clipped content, and all automated tests passed before deployment.

The real 18.4-second workflow is published on the separate NexaFlow Labs YouTube channel at `https://youtu.be/u-F4J-idMkY`, with tracked links to the free test and proof page. The NexaFlow Labs channel currently uses `@nexaflowlabs-tools`. The personal channel name and content were restored, but YouTube imposed a six-day rate limit before its `@nexaflowlabs` handle can be replaced with the available `@ricardovilela`; after that change, YouTube may retain the former handle URL for 14 days. YouTube requires phone verification for clickable external description links and a custom thumbnail, so a real automatic frame is used. The earlier copy on the personal channel was made private after the business-channel publication was verified. A NexaFlow Labs LinkedIn company page was not available, and Reddit blocked access behind a CAPTCHA before a business account could be verified.

IndexNow support was added using the existing public key file, sitemap-only URL validation and a dry-run mode. Six new verified partner prospects were selected from official business websites: five ecommerce product-photography studios and one Portuguese Shopify agency. One first-contact email was sent to each from `support@batchcutout.com`, and all six sends returned a successful provider identifier. Each partner received an individual campaign identifier, a concise two-image test request and an explicit opt-out. The message does not promise commission or position BatchCutout as a replacement for professional photography or retouching. No follow-up is scheduled.

The next organic review is 2026-08-14. Compare YouTube and partner UTM visitors through file-picker open, upload and completed test; review Search Console impressions and clicks for the product-photo page; and keep the offer unchanged until 30 completed tests are reached. Ads remain paused and no price increase is authorized.

## AlternativeTo organic distribution - 2026-08-07

The seven-day age gate on the company account `batchcutoutapp` elapsed and BatchCutout was submitted to AlternativeTo under submission ID `eb7abd1f-8df4-4b5f-95a3-d730aa960bf3`. The submission uses only the NexaFlow Labs identity and includes the tracked comparison landing, accurate Freemium purchase/subscription positioning, EN/PT/ES languages, Online/SaaS platforms, the existing icon, three validated commercial screenshots and the real NexaFlow Labs YouTube workflow.

Remove.bg and PhotoRoom were selected as two genuine alternatives. AlternativeTo confirmed the submission is in its normal free queue, currently expected to take a few months, and that the pending listing is visible only to the submitting account until approval. The paid priority option was not selected, no personal account was used and no money was spent. Do not share the pending listing URL before approval; monitor `My submissions` and `support@batchcutout.com` for the review decision.

The same support-inbox review found that Uneed had rejected BatchCutout on 2026-08-03 because it declines categories it considers saturated or generic. Uneed must not be counted as pending or as future organic distribution, and no appeal or paid placement is planned. There was no customer or buyer message requiring a response. The Uneed rejection is now resolved; four non-customer operational notices remain in the inbox and require no reply.

## Direct free-test activation - 2026-08-07

The authenticated dashboard identified the first interaction with the tool as the strongest current bottleneck. Today, nine unique visitors produced ten tool-page views and ten upload-zone exposures, but no file-picker open or upload. Over 14 days, 73 visitors produced 19 upload-zone exposures and only six file-picker opens; the measured zone-to-picker rate was 33% on mobile and 8% on desktop. Over 30 days, 196 visitors produced 38 uploads, 30 ready results, 25 downloads and eight completed free tests. Stripe still recorded one real Pack purchase from two Pack sessions, so price and checkout are not the first constraint to change.
...
## Paid alternative direct activation - 2026-08-16

Production, pricing, admin and authentication routes returned HTTP 200, and the repository was clean and synchronized at commit `e7b89c4` before this review. From 12 through 16 August, the authenticated application data attributed seven unique visitors and ten page views to the active `remove_bg_alternative` Google Ads campaign. Three visitors reached the tool, two opened the file picker and uploaded images, and one downloaded a result. There was no completed free test, paid intent, Stripe session, purchase or revenue in this cohort. On 16 August specifically, two paid visitors reached the campaign landing and neither entered the tool.

The active campaign landing did not enable the direct paid-search handoff already supported and measured by the shared landing script. It now sends paid-search visits directly to the English upload workspace while preserving click and campaign parameters; organic and untagged visitors remain on the indexable comparison page. Internal campaign-oriented copy on the organic page was also replaced with a customer-facing instruction. All 59 automated tests passed, and production served the direct-handoff marker and cache-busted script after deployment at commit `92fa326`.

No price, free allowance, email, advertisement, keyword, bid, campaign or budget setting changed. The authenticated Google Ads promotion and cost guard could not be checked in this review because the `ricardojvilela` Chrome profile was not connected; this must be verified at the next available review before any conclusion about test spend.

## Controlled Google Ads test closure - 2026-08-25

Production, pricing and admin routes returned HTTP 200, and the repository was clean and synchronized at commit `6b37b01` before this review. The authenticated application report for 12 through 25 August contained 63 unique visitors, 19 uploads, 14 completed processing journeys, five downloads and three completed `free_total_2` tests. Google Ads accounted for 26 visitors, 27 tool-page views, 26 upload-zone exposures, 19 uploads, five downloads, two paid-intent visitors and one Pack Stripe session, but no purchase or revenue. The measured activation funnel contained 28 unique upload-zone visitors. The global offer-change gate remains blocked at 11 of 30 completed tests.

The authenticated `BATCH CUT OUT` Google Ads account reported 322 impressions, 26 clicks, an 8.07% CTR and 72.28 EUR of cost for `Search - BatchCutout - Alternatives` from 12 through 25 August. Because the cost exceeded the explicitly authorized 70 EUR limit, the campaign was immediately changed to `Em pausa`. Google Ads confirmed that the change was saved. `Search - BatchCutout - Pro Launch` and `Campaign #1` remained paused, and the MarginWatch campaign was not changed.

At closure, the 250 EUR promotion remained active and financing campaigns, with 173.61 EUR used and 76.39 EUR available until 2026-09-19. The separate 400 EUR promotion was also active until 2026-10-16, with usage data still unavailable. The Alternatives campaign must not be reactivated without explicit approval.

There was no new purchase, paid subscription or renewable MRR. The only real Pack payment remains the 9 EUR purchase from 2026-07-16, fully reconciled and linked to an active account whose 250 credits remain unused. The support mailbox contained 12 unresolved newsletters, directory notices or automated messages and no customer enquiry, buyer reply or opt-out requiring action. No price, free allowance, offer or email changed.
