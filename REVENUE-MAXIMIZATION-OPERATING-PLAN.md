...
The same support-inbox review found that Uneed had rejected BatchCutout on 2026-08-03 because it declines categories it considers saturated or generic. Uneed must not be counted as pending or as future organic distribution, and no appeal or paid placement is planned. There was no customer or buyer message requiring a response. Three non-customer notifications were resolved; five non-customer operational notices remain in the inbox and require no reply.
