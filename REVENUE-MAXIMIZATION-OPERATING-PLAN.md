...
The real 18.4-second workflow was published on the NexaFlow Labs YouTube channel at `https://youtu.be/rwLI4TsguXQ`, with tracked links to the free test and proof page. YouTube requires phone verification for a custom thumbnail, so a real automatic frame is used. No personal social profile was used: a NexaFlow Labs LinkedIn company page was not available, and Reddit blocked access behind a CAPTCHA before a business account could be verified.
