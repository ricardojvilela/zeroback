...
- Follow-ups due next: 2026-07-07, 2026-07-08 and 2026-07-10.

## Today's rule

2026-07-06 support check passed before sending: 2 support emails were present, 0 unresolved, and 0 matched the 11 contacts planned for today.

Sent on 2026-07-06:

- 6 follow-ups from `OUTREACH-FOLLOWUP-2026-07-06.md`.
- 5 new proof-page emails from `OUTREACH-BATCH-2026-07-06.md`.

Do not send more direct outreach on 2026-07-06. The combined total is 11 emails, which is inside the warm-up cap.
...
The next prepared action is `OUTREACH-FOLLOWUP-2026-07-07.md`. Send it only after checking `support@batchcutout.com` replies in `/admin` and only if there are no negative replies or opt-outs.
...
Use them in small daily batches only after the 2026-07-07 and 2026-07-08 follow-ups are handled.
...
- Previous 2026-07-01 batch: follow-up from 2026-07-07 if no reply. Prioritize only the highest-score 10 to 15 because 41 rows are due.
