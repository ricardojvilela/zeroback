...
const leadAutoreplySources = new Set(["post_download", "post_download_inline", "result_ready", "result_ready_inline", "result_ready_sticky", "tool_limit_prompt", "checkout_account_prompt"]);
const leadAutoreplyDownloadTypes = new Set(["png", "zip", "png_available", "zip_available", "batch_limit", "checkout_plan"]);
